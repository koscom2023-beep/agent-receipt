...
2. **Spec URL namespace**: this spec is published at `receipt.promptia.kr/spec`. The `predicateType` URIs live on a Promptia Labs domain (`promptia-labs.dev`): `.../agent-receipt/ai-work/v0.1` and `.../agent-receipt/claim-verification/v1`.
