...
감사 흐름(요약):
  ...
  done [--claim <c.json>] [--client] [--ledger] / commit-check / trailer
  close-recon / prepare-commit [--message <m>] [--include-linked-tests] / finish [--message <m>] [--client]
증빙/감사 묶음:
...
배포/메모(0.9 — read-only/증거):
  release-check --base <ref> [--failed-tests <f>] [--observe <ev>] / next
  note --type <recon|contract-draft|no-code-decision|next-options> [--message <m>]
점검/기타:
  doctor / lint / run
